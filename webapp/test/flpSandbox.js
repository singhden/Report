		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#zurichfscmuicpcdhis-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zurichfscmuicpcdhis-display": {
								"semanticObject": "zurichfscmuicpcdhis",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zurich.fscm.ui.cpcd.his",
									"url": sap.ui.require.toUrl("zurich/fscm/ui/cpcd/his")
								}
							}
						}
					}
